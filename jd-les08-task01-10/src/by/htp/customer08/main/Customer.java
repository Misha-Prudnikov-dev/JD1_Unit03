...
public class Customer {
	...
	public Customer(String name, String surname, String patronymic, String address, int id, int creditCardNumber,
	...
	public String toString() {
		return "Customer [ Name : " + name + ", Surname : " + surname + ", Patronymic : " + patronymic + ", Address : "
				+ address + ", ID : " + id + ", Credit Card Number : " + creditCardNumber + ", Bank Account Number : "
				+ bankAccountNumber + " ]";
	}
}